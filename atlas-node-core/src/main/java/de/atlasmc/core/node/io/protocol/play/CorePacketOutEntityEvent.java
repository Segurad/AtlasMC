...
public class CorePacketOutEntityEvent implements PacketCodec<PacketOutEntityEvent> {

	@Override
	public void deserialize(PacketOutEntityEvent packet, ByteBuf in, ConnectionHandler handler) throws IOException {
		packet.entityID = in.readInt();
		packet.status = in.readByte();
	}

	@Override
	public void serialize(PacketOutEntityEvent packet, ByteBuf out, ConnectionHandler handler) throws IOException {
