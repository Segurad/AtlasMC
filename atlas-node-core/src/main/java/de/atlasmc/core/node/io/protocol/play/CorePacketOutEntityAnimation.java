...
public class CorePacketOutEntityAnimation implements PacketCodec<PacketOutEntityAnimation> {

	@Override
	public void deserialize(PacketOutEntityAnimation packet, ByteBuf in, ConnectionHandler handler) throws IOException {
		packet.entityID = readVarInt(in);
		packet.animation = EnumUtil.getByID(Animation.class, in.readUnsignedByte());
	}

	@Override
	public void serialize(PacketOutEntityAnimation packet, ByteBuf out, ConnectionHandler handler) throws IOException {
