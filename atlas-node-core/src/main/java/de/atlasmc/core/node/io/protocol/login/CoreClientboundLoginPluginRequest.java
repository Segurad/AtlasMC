...
public class CoreClientboundLoginPluginRequest implements PacketCodec<ClientboundLoginPluginRequest> {

	@Override
	public void deserialize(ClientboundLoginPluginRequest packet, ByteBuf in, ConnectionHandler con) throws IOException {
	...
	@Override
	public void serialize(ClientboundLoginPluginRequest packet, ByteBuf out, ConnectionHandler con) throws IOException {
