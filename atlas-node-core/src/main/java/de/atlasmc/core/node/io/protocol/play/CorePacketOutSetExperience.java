...
public class CorePacketOutSetExperience implements PacketCodec<PacketOutSetExperiance> {

	@Override
	public void deserialize(PacketOutSetExperiance packet, ByteBuf in, ConnectionHandler handler) throws IOException {
	...
	@Override
	public void serialize(PacketOutSetExperiance packet, ByteBuf out, ConnectionHandler handler) throws IOException {
