...
public class CorePacketOutSetPlayerInventory implements PacketCodec<PacketOutSetPlayerInventory> {

	@Override
	public void deserialize(PacketOutSetPlayerInventory packet, ByteBuf in, ConnectionHandler con) throws IOException {
		packet.slot = readVarInt(in);
		packet.item = ItemStack.STREAM_CODEC.deserialize(in, con.getCodecContext());
	}

	@Override
	public void serialize(PacketOutSetPlayerInventory packet, ByteBuf out, ConnectionHandler con) throws IOException {
