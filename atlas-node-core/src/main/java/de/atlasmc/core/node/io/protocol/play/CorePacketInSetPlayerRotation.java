...
public class CorePacketInSetPlayerRotation implements PacketCodec<PacketInSetPlayerRotation> {
	
	@Override
	public void deserialize(PacketInSetPlayerRotation packet, ByteBuf in, ConnectionHandler con) throws IOException {
	...
	@Override
	public void serialize(PacketInSetPlayerRotation packet, ByteBuf out, ConnectionHandler con) throws IOException {
