...
public class CorePacketOutSetHealth implements PacketCodec<PacketOutSetHealth> {

	@Override
	public void deserialize(PacketOutSetHealth packet, ByteBuf in, ConnectionHandler handler) throws IOException {
	...
	@Override
	public void serialize(PacketOutSetHealth packet, ByteBuf out, ConnectionHandler handler) throws IOException {
