...
public class CorePacketOutSetTabListHeaderAndFooter implements PacketCodec<PacketOutSetTabListHeaderAndFooter> {

	@Override
	public void deserialize(PacketOutSetTabListHeaderAndFooter packet, ByteBuf in, ConnectionHandler handler) throws IOException {
	...
	@Override
	public void serialize(PacketOutSetTabListHeaderAndFooter packet, ByteBuf out, ConnectionHandler handler) throws IOException {
		final CodecContext context = handler.getCodecContext();
