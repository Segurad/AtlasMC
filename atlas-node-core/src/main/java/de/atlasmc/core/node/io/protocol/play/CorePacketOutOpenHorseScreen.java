...
public class CorePacketOutOpenHorseScreen implements PacketCodec<PacketOutOpenHorseScreen> {

	@Override
	public void deserialize(PacketOutOpenHorseScreen packet, ByteBuf in, ConnectionHandler handler) throws IOException {
	...
	@Override
	public void serialize(PacketOutOpenHorseScreen packet, ByteBuf out, ConnectionHandler handler) throws IOException {
