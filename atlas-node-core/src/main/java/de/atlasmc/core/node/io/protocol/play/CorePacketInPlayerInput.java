...
public class CorePacketInPlayerInput implements PacketCodec<PacketInPlayerInput> {

	@Override
	public void deserialize(PacketInPlayerInput packet, ByteBuf in, ConnectionHandler handler) throws IOException {
	...
	@Override
	public void serialize(PacketInPlayerInput packet, ByteBuf out, ConnectionHandler handler) throws IOException {
