...
public class CorePacketOutPlaceGhostRecipe implements PacketCodec<PacketOutPlaceGhostRecipe> {

	@Override
	public void deserialize(PacketOutPlaceGhostRecipe packet, ByteBuf in, ConnectionHandler con) throws IOException {
		packet.windowID = in.readByte();
		packet.recipeID = NamespacedKey.STREAM_CODEC.deserialize(null, in, null);
	}

	@Override
	public void serialize(PacketOutPlaceGhostRecipe packet, ByteBuf out, ConnectionHandler con) throws IOException {
