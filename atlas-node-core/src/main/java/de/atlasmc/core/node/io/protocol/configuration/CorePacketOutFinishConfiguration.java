...
public class CorePacketOutFinishConfiguration implements PacketCodec<ClientboundFinishConfiguration> {

	@Override
	public void deserialize(ClientboundFinishConfiguration packet, ByteBuf in, ConnectionHandler con) throws IOException {
		// packet does not contain data
	}

	@Override
	public void serialize(ClientboundFinishConfiguration packet, ByteBuf out, ConnectionHandler con) throws IOException {
		// packet does not contain data
	}
