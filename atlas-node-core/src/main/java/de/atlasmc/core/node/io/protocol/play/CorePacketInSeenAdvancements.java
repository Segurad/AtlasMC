...
public class CorePacketInSeenAdvancements implements PacketCodec<PacketInSeenAdvancements> {

	@Override
	public void deserialize(PacketInSeenAdvancements packet, ByteBuf in, ConnectionHandler con) throws IOException {
		packet.action = EnumUtil.getByID(Action.class, in.readInt());
		packet.tabID = NamespacedKey.STREAM_CODEC.deserialize(null, in, null);
	}

	@Override
	public void serialize(PacketInSeenAdvancements packet, ByteBuf out, ConnectionHandler con) throws IOException {
