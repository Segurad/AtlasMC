...
public class CorePacketOutChangeDifficulty implements PacketCodec<PacketOutChangeDifficulty> {

	@Override
	public void deserialize(PacketOutChangeDifficulty packet, ByteBuf in, ConnectionHandler handler) throws IOException {
		packet.difficulty = EnumUtil.getByID(Difficulty.class, in.readUnsignedByte());
		packet.locked = in.readBoolean();
	}

	@Override
	public void serialize(PacketOutChangeDifficulty packet, ByteBuf out, ConnectionHandler handler) throws IOException {
