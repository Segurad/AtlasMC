...
public class CorePacketOutCombatDeath implements PacketCodec<PacketOutCombatDeath> {

	@Override
	public void deserialize(PacketOutCombatDeath packet, ByteBuf in, ConnectionHandler con) throws IOException {
		packet.playerID = readVarInt(in);
		packet.deathMessage = Chat.STREAM_CODEC.deserialize(in, con.getCodecContext());
	}

	@Override
	public void serialize(PacketOutCombatDeath packet, ByteBuf out, ConnectionHandler con) throws IOException {
