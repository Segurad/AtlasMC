...
public class CorePacketInUpdateSign implements PacketCodec<PacketInUpdateSign> {

	@Override
	public void deserialize(PacketInUpdateSign packet, ByteBuf in, ConnectionHandler handler) throws IOException {
	...
	@Override
	public void serialize(PacketInUpdateSign packet, ByteBuf out, ConnectionHandler handler) throws IOException {
