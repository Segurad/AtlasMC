...
public class CorePacketOutSetDefaultSpawnPosition implements PacketCodec<PacketOutSetDefaultSpawnPosition> {

	@Override
	public void deserialize(PacketOutSetDefaultSpawnPosition packet, ByteBuf in, ConnectionHandler handler) throws IOException {
		packet.position = in.readLong();
		packet.angel = in.readFloat();
	}

	@Override
	public void serialize(PacketOutSetDefaultSpawnPosition packet, ByteBuf out, ConnectionHandler handler) throws IOException {
