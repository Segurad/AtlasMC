...
public class CorePacketInUseItem implements PacketCodec<PacketInUseItem> {

	@Override
	public void deserialize(PacketInUseItem packet, ByteBuf in, ConnectionHandler handler) throws IOException {
	...
	@Override
	public void serialize(PacketInUseItem packet, ByteBuf out, ConnectionHandler handler) throws IOException {
