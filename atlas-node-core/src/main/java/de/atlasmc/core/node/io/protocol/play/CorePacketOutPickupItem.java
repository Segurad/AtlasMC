...
public class CorePacketOutPickupItem implements PacketCodec<PacketOutPickupItem> {

	@Override
	public void deserialize(PacketOutPickupItem packet, ByteBuf in, ConnectionHandler handler) throws IOException {
	...
	@Override
	public void serialize(PacketOutPickupItem packet, ByteBuf out, ConnectionHandler handler) throws IOException {
