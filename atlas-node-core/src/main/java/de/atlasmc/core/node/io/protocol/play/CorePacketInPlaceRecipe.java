...
public class CorePacketInPlaceRecipe implements PacketCodec<PacketInPlaceRecipe> {

	@Override
	public void deserialize(PacketInPlaceRecipe packet, ByteBuf in, ConnectionHandler con) throws IOException {
	...
	@Override
	public void serialize(PacketInPlaceRecipe packet, ByteBuf out, ConnectionHandler con) throws IOException {
