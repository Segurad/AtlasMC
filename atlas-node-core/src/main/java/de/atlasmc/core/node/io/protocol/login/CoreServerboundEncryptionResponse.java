...
public class CoreServerboundEncryptionResponse implements PacketCodec<ServerboundEncryptionResponse> {

	@Override
	public void deserialize(ServerboundEncryptionResponse packet, ByteBuf in, ConnectionHandler con) throws IOException {
	...
	@Override
	public void serialize(ServerboundEncryptionResponse packet, ByteBuf out, ConnectionHandler con) throws IOException {
