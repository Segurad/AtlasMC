...
public class CorePacketOutResetScore implements PacketCodec<PacketOutResetScore> {

	@Override
	public void deserialize(PacketOutResetScore packet, ByteBuf in, ConnectionHandler con) throws IOException {
	...
	@Override
	public void serialize(PacketOutResetScore packet, ByteBuf out, ConnectionHandler con) throws IOException {
