...
public class CorePacketOutWorldEvent implements PacketCodec<PacketOutWorldEvent> {

	@Override
	public void deserialize(PacketOutWorldEvent packet, ByteBuf in, ConnectionHandler handler) throws IOException {
	...
	@Override
	public void serialize(PacketOutWorldEvent packet, ByteBuf out, ConnectionHandler handler) throws IOException {
