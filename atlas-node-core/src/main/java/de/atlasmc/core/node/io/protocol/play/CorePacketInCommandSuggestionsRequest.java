...
public class CorePacketInCommandSuggestionsRequest implements PacketCodec<PacketInCommandSuggestionsRequest> {

	@Override
	public void deserialize(PacketInCommandSuggestionsRequest packet, ByteBuf in, ConnectionHandler handler) throws IOException {
		packet.transactionID = readVarInt(in);
		packet.text = StringCodec.readString(in);
	}

	@Override
	public void serialize(PacketInCommandSuggestionsRequest packet, ByteBuf out, ConnectionHandler handler) throws IOException {
