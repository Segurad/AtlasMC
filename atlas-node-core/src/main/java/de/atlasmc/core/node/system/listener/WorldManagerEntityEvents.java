...
import de.atlasmc.node.event.entity.EntityDamageByBlockEvent;
import de.atlasmc.node.event.entity.EntityDamageByEntityEvent;
import de.atlasmc.node.event.entity.EntityDamageEvent;
import de.atlasmc.node.event.entity.EntitySpawnEvent;
import de.atlasmc.node.event.entity.FoodLevelChangeEvent;
import de.atlasmc.node.event.entity.EntityDamageEvent.DamageCause;
