...
public class CorePacketOutSetTickingState implements PacketCodec<PacketOutSetTickingState> {

	@Override
	public void deserialize(PacketOutSetTickingState packet, ByteBuf in, ConnectionHandler con) throws IOException {
		packet.tickRate = in.readFloat();
		packet.frozen = in.readBoolean();
	}

	@Override
	public void serialize(PacketOutSetTickingState packet, ByteBuf out, ConnectionHandler con) throws IOException {
