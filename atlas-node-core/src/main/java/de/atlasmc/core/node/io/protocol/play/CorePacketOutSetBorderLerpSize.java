...
public class CorePacketOutSetBorderLerpSize implements PacketCodec<PacketOutSetBorderLerpSize> {

	@Override
	public void deserialize(PacketOutSetBorderLerpSize packet, ByteBuf in, ConnectionHandler con) throws IOException {
	...
	@Override
	public void serialize(PacketOutSetBorderLerpSize packet, ByteBuf out, ConnectionHandler con) throws IOException {
