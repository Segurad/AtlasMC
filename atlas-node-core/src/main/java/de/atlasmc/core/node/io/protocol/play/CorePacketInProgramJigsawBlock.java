...
public class CorePacketInProgramJigsawBlock implements PacketCodec<PacketInProgramJigsawBlock> {

	@Override
	public void deserialize(PacketInProgramJigsawBlock packet, ByteBuf in, ConnectionHandler handler) throws IOException {
	...
	@Override
	public void serialize(PacketInProgramJigsawBlock packet, ByteBuf out, ConnectionHandler handler) throws IOException {
