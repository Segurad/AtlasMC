...
public class CorePacketInEditBook implements PacketCodec<PacketInEditBook> {

	@Override
	public void deserialize(PacketInEditBook packet, ByteBuf in, ConnectionHandler con) throws IOException {
	...
	@Override
	public void serialize(PacketInEditBook packet, ByteBuf out, ConnectionHandler con) throws IOException {
