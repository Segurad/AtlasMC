...
public class CoreCompassMeta extends CoreItemMeta implements CompassMeta {
	...
	protected static final CharKey 
			LODESTONE_TRACKED = CharKey.literal("LodestoneTracked"),
			LODESTONE_DIMENSION = CharKey.literal("LodestoneDimension"),
			LODESTONE_POS = CharKey.literal("LodestonePos"),
			POS_X = CharKey.literal("X"),
			POS_Y = CharKey.literal("Y"),
			POS_Z = CharKey.literal("Z");
