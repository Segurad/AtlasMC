...
public class CorePacketOutUpdateTags implements PacketIO<PacketOutUpdateTags> {
	...
	@Override
	public void read(PacketOutUpdateTags packet, ByteBuf in, ConnectionHandler con) throws IOException {
	...
	@Override
	public void write(PacketOutUpdateTags packet, ByteBuf out, ConnectionHandler con) throws IOException {
		if (packet.tags != null) {
