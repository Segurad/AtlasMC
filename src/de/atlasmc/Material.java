...
public class Material {
	...
	static {
		...
		TRAP_DOOR_MDF = new ClassMetaDataFactory(TrapDoor.class, null),
		...
		GLASS_PANE_MDF = new ClassMetaDataFactory(GlassPane.class, null),
		SLAB_MDF = new ClassMetaDataFactory(Slab.class, null),
		OBSERVER_MDF = new  ClassMetaDataFactory(Observer.class, null),
		TURTLE_EGG_MDF = new ClassMetaDataFactory(TurtleEgg.class, null),
		WATERLOGGED_MDF = new ClassMetaDataFactory(Waterlogged.class, null),
		CORAL_WALL_FAN_MDF = new ClassMetaDataFactory(CoralWallFan.class, null),
		SEA_PICKLE_MDF = new ClassMetaDataFactory(SeaPickle.class, null),
		BAMBOO_MDF = new ClassMetaDataFactory(Bamboo.class, null),
		BUBBLE_COLUMN_MDF = new ClassMetaDataFactory(BubbleColumn.class, null),
		SCAFFOLDING_MDF = new ClassMetaDataFactory(Scaffolding.class, null),
		BARREL_MDF = new ClassMetaDataFactory(Barrel.class, null),
		GRINDSTONE_MDF = new ClassMetaDataFactory(Grindstone.class, null),
		LECTERN_MDF = new ClassMetaDataFactory(Lectern.class, null),
		BELL_MDF = new ClassMetaDataFactory(Bell.class, null),
		LANTERN_MDF = new ClassMetaDataFactory(Lantern.class, null),
		CAMPFIRE_MDF = new ClassMetaDataFactory(Campfire.class, null),
		STRUCTURE_BLOCK_MDF = new ClassMetaDataFactory(StructureBlock.class, null),
		JIGSAW_MDF = new ClassMetaDataFactory(Jigsaw.class, null),
		BEEHIVE_MDF = new ClassMetaDataFactory(Beehive.class, null),
		RESPAWN_ANCHOR_MDF = new ClassMetaDataFactory(RespawnAnchor.class, null),
		// --- Items ---
		...
		SHULKER_BOX = c("SHULKER_BOX", 9276, DIRECTIONAL_MDF);
		WHITE_SHULKER_BOX = c("WHITE_SHULKER_BOX", 9282, DIRECTIONAL_MDF);
		ORANGE_SHULKER_BOX = c("ORANGE_SHULKER", 9288, DIRECTIONAL_MDF);
		MAGENTA_SHULKER_BOX = c("MAGENTA_SHULKER_BOX", 9294, DIRECTIONAL_MDF);
		LIGHT_BLUE_SHULKER_BOX = c("LIGHT_BLUE_SHULKER_BOX", 9300, DIRECTIONAL_MDF);
		YELLOW_SHULKER_BOX = c("YELLOW_SHULKER_BOX", 9306);
		LIME_SHULKER_BOX = c("LIME_SHULKER_BOX", 9312, DIRECTIONAL_MDF);
		PINK_SHULKER_BOX = c("PINK_SHULKER_BOX", 9318, DIRECTIONAL_MDF);
		GRAY_SHULKER_BOX = c("GRAY_SHULKER_BOX", 9324, DIRECTIONAL_MDF);
		LIGHT_GRAY_SHULKER_BOX = c("LIGHT_GRAY_SHULKER_BOX", 9330, DIRECTIONAL_MDF);
		CYAN_SHULKER_BOX = c("CYAN_SHULKER_BOX", 9336, DIRECTIONAL_MDF);
		PURPLE_SHULKER_BOX = c("PURPLE_SHULKER_BOX", 9342, DIRECTIONAL_MDF);
		BLUE_SHULKER_BOX = c("BLUE_SHULKER_BOX", 9348, DIRECTIONAL_MDF);
		BROWN_SHULKER_BOX = c("BROWN_SHULKER", 9354, DIRECTIONAL_MDF);
		GREEN_SHULKER_BOX = c("GREEN_SHULKER_BOX", 9360, DIRECTIONAL_MDF);
		RED_SHULKER_BOX = c("RED_SHULKER_BOX", 9366, DIRECTIONAL_MDF);
		BLACK_SHULKER_BOX = c("BLACK_SHULKER_BOX", 9372, DIRECTIONAL_MDF);
		WHITE_GLAZED_TERRACOTTA = c("WHITE_GLAZED_TERRACOTTA", 9378, DIRECTIONAL_MDF);
		ORANGE_GLAZED_TERRACOTTA = c("ORANGE_GLAZED_TERRACOTTA", 9382, DIRECTIONAL_MDF);
		MAGENTA_GLAZED_TERRACOTTA = c("MAGENTA_GLAZED_TERRACOTTA", 9386, DIRECTIONAL_MDF);
		LIGHT_BLUE_GLAZED_TERRACOTTA = c("LIGHT_BLUE_GLAZED_TERRACOTTA", 9390, DIRECTIONAL_MDF);
		YELLOW_GLAZED_TERRACOTTA = c("YELLOW_GLAZED_TERRACOTTA", 9394, DIRECTIONAL_MDF);
		LIME_GLAZED_TERRACOTTA = c("LIME_GLAZED_TERRACOTTA", 9398, DIRECTIONAL_MDF);
		PINK_GLAZED_TERRACOTTA = c("PINK_GLAZED_TERRACOTTA", 94020, DIRECTIONAL_MDF);
		GRAY_GLAZED_TERRACOTTA = c("GRAY_GLAZED_TERRACOTTA", 9406, DIRECTIONAL_MDF);
		LIGHT_GRAY_GLAZED_TERRACOTTA = c("LIGHT_GRAY_GLAZED_TERRACOTTA", 9410, DIRECTIONAL_MDF);
		CYAN_GLAZED_TERRACOTTA = c("CYAN_GLAZED_TERRACOTTA", 9414, DIRECTIONAL_MDF);
		PURPLE_GLAZED_TERRACOTTA = c("PURPLE_GLAZED_TERRACOTTA", 9418, DIRECTIONAL_MDF);
		BLUE_GLAZED_TERRACOTTA = c("BLUE_GLAZED_TERRACOTTA", 9422, DIRECTIONAL_MDF);
		BROWN_GLAZED_TERRACOTTA = c("BROWN_GLAZED_TERRACOTTA", 9426, DIRECTIONAL_MDF);
		GREEN_GLAZED_TERRACOTTA = c("GREEN_GLAZED_TERRACOTTA", 9430, DIRECTIONAL_MDF);
		RED_GLAZED_TERRACOTTA = c("RED_GLAZED_TERRACOTTA", 9434, DIRECTIONAL_MDF);
		BLACK_GLAZED_TERRACOTTA = c("BLACK_GLAZED_TERRACOTTA", 9438, DIRECTIONAL_MDF);
		...
		LOOM = c("LOOM", 14791, DIRECTIONAL_MDF);
	...
	public ItemMeta createItemMeta() {
		return createItemMeta(null);
	}
	
	public ItemMeta createItemMeta(NBT nbt) {
		MetaDataFactory mdf = getMetaDataFactory();
		if (mdf == null) return MetaDataFactory.DEFAULT.createMeta(this, nbt);
		return mdf.createMeta(this, nbt);
	}
