...
public class CoreEffectInstantDamage extends CoreAbstractPotionEffect {
	...
	public CoreEffectInstantDamage(PotionEffectType type, int amplifier, int duration, boolean reducedAmbient, boolean particles, boolean icon) {
		super(type, amplifier, -1, reducedAmbient, particles, icon);
	}

	@Override
	public void addEffect(LivingEntity entity) {
		entity.damage(3*Math.pow(2, amplifier));
