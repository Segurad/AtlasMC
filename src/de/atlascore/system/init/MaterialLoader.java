...
import de.atlascore.block.data.CoreOrientableXZ;
...
import de.atlasmc.factory.DirectionalMetaDataFactory;
import de.atlasmc.factory.LevelledClassMetaDataFactory;
import de.atlasmc.factory.LightableMetaDataFactory;
import de.atlasmc.factory.MetaDataFactory;
import de.atlasmc.factory.MultipleFacingMetaDataFactory;
import de.atlasmc.factory.TileEntityFactory;
import de.atlasmc.factory.WaterloggedMetaDataFactory;
...
public class MaterialLoader {
	...
	private static synchronized void load() {
		...
		MetaDataFactory AIR_MDF = new ClassMetaDataFactory(null, null, BlockData.class, CoreBlockData.class),
				...
				LEVELLED_3_MDF = new LevelledClassMetaDataFactory(Levelled.class, CoreLevelled.class, 3),
				ORIENTABLE_MDF = new ClassMetaDataFactory(Orientable.class, CoreOrientable.class),
				ORIENTABLE_XZ_MDF = new ClassMetaDataFactory(Orientable.class, CoreOrientableXZ.class),
				...
				DIRECTIONAL6F_UP_MDF = new DirectionalMetaDataFactory(Directional.class, CoreDirectional6Faces.class, BlockFace.UP),
				...
				LIGHTABLE_LIT_MDF = new LightableMetaDataFactory(Lightable.class, CoreLightable.class, true),
				...
				MULTIPLE_FACING6_ALL_MDF = new MultipleFacingMetaDataFactory(MultipleFacing.class, CoreMultipleFacing6.class, 
				...
				WATERLOGGED_TRUE_MDF = new WaterloggedMetaDataFactory(Waterlogged.class, CoreWaterlogged.class, true),
		...
		BUBBLE_COLUMN = new Material(NamespacedKey.MINECRAFT, "BUBBLE_COLUMN", false, (short) 9671, (byte) 1, 0, 0, BUBBLE_COLUMN_MDF);
		STONE = c("STONE", 1);
		GRANITE = c("GRANITE", 2);
		...
		STRIPPED_CRIMSON_HYPHAE = c("STRIPPED_CRIMSON_HYPHAE", 14992, ORIENTABLE_MDF);
		...
		LIGHT_GRAY_WOOL = c("LIGHT_GRAY_WOOL", 1392);
		...
		CRIMSON_FUNGUS = c("CRIMSON_FUNGUS", 14996);
		...
		CUT_SANDSTONE_SLAB = c("CUT_SANDSTONE_SLAB", 8358, SLAB_MDF);
		...
		STONE_BRICK_SLAB = c("STONE_BRICK_SLAB", 8382, SLAB_MDF);
		...
		END_ROD = c("END_ROD", 9062, DIRECTIONAL6F_UP_MDF);
		...
		REDSTONE_WIRE = c("REDSTONE_WIRE", 2058, REDSTONE_WIRE_MDF);
		...
		POLISHED_BLACKSTONE_PRESSURE_PLATE = c("POLISHED_BLACKSTONE_PRESSURE_PLATE", 16759, POWERABLE_MDF);
		REDSTONE_ORE = c("REDSTONE_ORE", 3885, LIGHTABLE_MDF);
		REDSTONE_TORCH = c("REDSTONE_TORCH", 3887, LIGHTABLE_LIT_MDF);
		...
		NETHER_PORTAL = new Material(NamespacedKey.MINECRAFT, "NETHER_PORTAL", false, (short) 4014, (byte) 1, 0, 0, ORIENTABLE_XZ_MDF);
		...
		BROWN_MUSHROOM_BLOCK = c("BROWN_MUSHROOM_BLOCK", 4505, MULTIPLE_FACING6_ALL_MDF);
		RED_MUSHROOM_BLOCK = c("RED_MUSHROOM_BLOCK", 4569, MULTIPLE_FACING6_ALL_MDF);
		MUSHROOM_STEM = c("MUSHROOM_STEM", 4633, MULTIPLE_FACING6_ALL_MDF);
		IRON_BARS = c("IRON_BARS", 4697, FENCE_MDF);
		CHAIN = c("CHAIN", 4729, CHAIN_MDF);
		GLASS_PANE = c("GLASS_PANE", 4735, FENCE_MDF);
		MELON = c("MELON", 4767);
		ATTACHED_MELON_STEM = new Material(NamespacedKey.MINECRAFT, "ATTACHED_MELON_STEM", false, (short) 4772, (byte) 1, 0, 0, DIRECTIONAL4F_MDF);
		ATTACHED_PUMPKIN_STEM = new Material(NamespacedKey.MINECRAFT, "ATTACHED_PUMPKIN_STEM", false, (short) 4768, (byte) 1, 0, 0, DIRECTIONAL4F_MDF);
		...
		OAK_FENCE_GATE = c("OAK_FENCE_GATE", 4824, GATE_MDF);
		...
		REDSTONE_LAMP = c("REDSTONE_LAMP", 5160, LIGHTABLE_MDF);
		...
		DAYLIGHT_DETECTOR = c("DAYLIGHT_DETECTOR", 6698, DAYLIGHT_DETECTORE_MDF);
		...
		LIGHT_BLUE_STAINED_GLASS = c("LIGHT_BLUE_STAINED_GLASS", 4098);
		...
		ORANGE_STAINED_GLASS_PANE = c("ORANGE_STAINED_GLASS_PANE", 6899, GLASS_PANE_MDF);
		...
		DARK_PRISMARINE_STAIRS = c("DARK_PRISMARINE_STAIRS", 7768, STAIRS_MDF);
		SEA_LANTERN = c("SEA_LANTERN", 7866);
		RED_SANDSTONE = c("RED_SANDSTONE", 8221);
		CHISELED_RED_SANDSTONE = c("CHISELED_RED_SANDSTONE", 8222);
		...
		SHULKER_BOX = c("SHULKER_BOX", 9276, DIRECTIONAL6F_UP_MDF);
		WHITE_SHULKER_BOX = c("WHITE_SHULKER_BOX", 9282, DIRECTIONAL6F_UP_MDF);
		ORANGE_SHULKER_BOX = c("ORANGE_SHULKER_BOX", 9288, DIRECTIONAL6F_UP_MDF);
		MAGENTA_SHULKER_BOX = c("MAGENTA_SHULKER_BOX", 9294, DIRECTIONAL6F_UP_MDF);
		LIGHT_BLUE_SHULKER_BOX = c("LIGHT_BLUE_SHULKER_BOX", 9300, DIRECTIONAL6F_UP_MDF);
		YELLOW_SHULKER_BOX = c("YELLOW_SHULKER_BOX", 9306, DIRECTIONAL6F_UP_MDF);
		LIME_SHULKER_BOX = c("LIME_SHULKER_BOX", 9312, DIRECTIONAL6F_UP_MDF);
		PINK_SHULKER_BOX = c("PINK_SHULKER_BOX", 9318, DIRECTIONAL6F_UP_MDF);
		GRAY_SHULKER_BOX = c("GRAY_SHULKER_BOX", 9324, DIRECTIONAL6F_UP_MDF);
		LIGHT_GRAY_SHULKER_BOX = c("LIGHT_GRAY_SHULKER_BOX", 9330, DIRECTIONAL6F_UP_MDF);
		CYAN_SHULKER_BOX = c("CYAN_SHULKER_BOX", 9336, DIRECTIONAL6F_UP_MDF);
		PURPLE_SHULKER_BOX = c("PURPLE_SHULKER_BOX", 9342, DIRECTIONAL6F_UP_MDF);
		BLUE_SHULKER_BOX = c("BLUE_SHULKER_BOX", 9348, DIRECTIONAL6F_UP_MDF);
		BROWN_SHULKER_BOX = c("BROWN_SHULKER_BOX", 9354, DIRECTIONAL6F_UP_MDF);
		GREEN_SHULKER_BOX = c("GREEN_SHULKER_BOX", 9360, DIRECTIONAL6F_UP_MDF);
		RED_SHULKER_BOX = c("RED_SHULKER_BOX", 9366, DIRECTIONAL6F_UP_MDF);
		BLACK_SHULKER_BOX = c("BLACK_SHULKER_BOX", 9372, DIRECTIONAL6F_UP_MDF);
		...
		PINK_GLAZED_TERRACOTTA = c("PINK_GLAZED_TERRACOTTA", 9402, DIRECTIONAL4F_MDF);
		...
		GREEN_CONCRETE = c("GREEN_CONCRETE", 9455);
		RED_CONCRETE = c("RED_CONCRETE", 9456);
		...
		TUBE_CORAL = c("TUBE_CORAL", 9534, WATERLOGGED_TRUE_MDF);
		BRAIN_CORAL = c("BRAIN_CORAL", 9536, WATERLOGGED_TRUE_MDF);
		BUBBLE_CORAL = c("BUBBLE_CORAL", 9538, WATERLOGGED_TRUE_MDF);
		FIRE_CORAL = c("FIRE_CORAL", 9540, WATERLOGGED_TRUE_MDF);
		HORN_CORAL = c("HORN_CORAL", 9542, WATERLOGGED_TRUE_MDF);
		DEAD_BRAIN_CORAL = c("DEAD_BRAIN_CORAL", 9526, WATERLOGGED_TRUE_MDF);
		DEAD_BUBBLE_CORAL = c("DEAD_BUBBLE_CORAL", 9528, WATERLOGGED_TRUE_MDF);
		DEAD_FIRE_CORAL = c("DEAD_FIRE_CORAL", 9530, WATERLOGGED_TRUE_MDF);
		DEAD_HORN_CORAL = c("DEAD_HORN_CORAL", 9532, WATERLOGGED_TRUE_MDF);
		DEAD_TUBE_CORAL = c("DEAD_TUBE_CORAL", 9524, WATERLOGGED_TRUE_MDF);
		TUBE_CORAL_FAN = c("TUBE_CORAL_FAN", 9554, WATERLOGGED_TRUE_MDF);
		BRAIN_CORAL_FAN = c("BRAIN_CORAL_FAN", 9556, WATERLOGGED_TRUE_MDF);
		BUBBLE_CORAL_FAN = c("BUBBLE_CORAL_FAN", 9558, WATERLOGGED_TRUE_MDF);
		FIRE_CORAL_FAN = c("FIRE_CORAL_FAN", 9560, WATERLOGGED_TRUE_MDF);
		HORN_CORAL_FAN = c("HORN_CORAL_FAN", 9562, WATERLOGGED_TRUE_MDF);
		DEAD_TUBE_CORAL_FAN = c("DEAD_TUBE_CORAL_FAN", 9544, WATERLOGGED_TRUE_MDF);
		DEAD_BRAIN_CORAL_FAN = c("DEAD_BRAIN_CORAL_FAN", 9546, WATERLOGGED_TRUE_MDF);
		DEAD_BUBBLE_CORAL_FAN = c("DEAD_BUBBLE_CORAL_FAN", 9548, WATERLOGGED_TRUE_MDF);
		DEAD_FIRE_CORAL_FAN = c("DEAD_FIRE_CORAL_FAN", 9550, WATERLOGGED_TRUE_MDF);
		DEAD_HORN_CORAL_FAN = c("DEAD_HORN_CORAL_FAN", 9552, WATERLOGGED_TRUE_MDF);
		...
		CONDUIT = c("CONDUIT", 9653, WATERLOGGED_TRUE_MDF);
		...
		SMOOTH_SANDSTONE_STAIRS = c("SMOOTH_SANDSTONE_STAIRS", 10233, STAIRS_MDF);
		...
		JUNGLE_WALL_SIGN = new Material(NamespacedKey.MINECRAFT, "JUNGLE_WALL_SIGN", false, (short) 3767, (byte) 1, 0, 0, WALL_SIGN_MDF);
		ACACIA_WALL_SIGN = new Material(NamespacedKey.MINECRAFT, "ACACIA_WALL_SIGN", false, (short) 3759, (byte) 1, 0, 0, WALL_SIGN_MDF);
		...
		CAULDRON = c("CAULDRON", 5145, LEVELLED_3_MDF);
		...
		POTTED_BAMBOO = new Material(NamespacedKey.MINECRAFT, "potted_bamboo", false, (short) 9668, (byte) 0, 0, 0);
		...
		CHISELED_POLISHED_BLACKSTONE = c("CHISELED_POLISHED_BLACKSTONE", 16261);
