...
public class CorePlayerDiggingHandler implements DiggingHandler {
	...
	public void sendAnimation() {
		...
		if (viewers.isEmpty())
			return;
		PacketOutBlockBreakAnimation packet = createAnimationPacket();
	 ...
	 * @return packet
	 */
	protected PacketOutBlockBreakAnimation createAnimationPacket() {
		PacketOutBlockBreakAnimation packet = new PacketOutBlockBreakAnimation();
