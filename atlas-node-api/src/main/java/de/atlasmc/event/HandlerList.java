...
public class HandlerList {
	 ...
	 */
	public static void registerListener(Plugin plugin, Listener listener, Object... handleroptions) {
		if (listener == null) 
			return;
	...
	public static <E extends Event> void registerFunctionalListener(Plugin plugin, Class<E> eventClass, FunctionalListener<E> listener, Object... handleroptions) {
