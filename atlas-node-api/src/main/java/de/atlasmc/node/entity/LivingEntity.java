...
public interface LivingEntity extends Entity, Attributeable, ProjectileSource {
	...
	NBT_CODEC = NBTCodec
					...
					.codecCollection("active_effects", LivingEntity::hasPotionEffects, LivingEntity::getActivePotionEffects, LivingEntity::addPotionEffect, PotionEffect.NBT_CODEC)
					.codecCollectionInnerSearchKey("attributes", LivingEntity::hasAttributes, LivingEntity::getAttributes, "id", Attribute::getByName, LivingEntity::getAttribute, AttributeInstance::getAttribute)
					// Brain
					...
					.innerCodecCompoundField("drop_chances", LivingEntity::getEquipment, EntityEquipment.NBT_DROP_CHANCE_HANDLER)
					.innerCodecCompoundField("equipment", LivingEntity::getEquipment, EntityEquipment.NBT_EQUIPMENT_HANDLER)
