...
public interface Merchant extends InventoryHolder {
	...
	public static class MerchantRecipe implements Cloneable, NBTSerializable {
		...
		NBT_HANDLER = NBTCodec
						...
						.codec("buyB", MerchantRecipe::getInputItem2, MerchantRecipe::setInputItem2, ItemStack.NBT_CODEC)
						...
						.codec("sell", MerchantRecipe::getOutputItem, MerchantRecipe::setOutputItem, ItemStack.NBT_CODEC)
