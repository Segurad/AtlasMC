...
class ConcurrentLinkedListIteratorTest {
    ...
    private void assertState(
        ...
        if (expected.length == 0) {
            ...
            assertEquals(expected[expected.length - 1],
                    list.getTail());
        }
    }
    ...
    void testIteratorOnEmptyList() {
        ...
        ConcurrentLinkedList.LinkedListIterator<String> iterator =
                list.iterator();
    ...
    @Test
    @DisplayName("Iterator addBefore null throws")
    void testIteratorAddBeforeNullThrows() {
        ConcurrentLinkedList<String> list =
                newList("A");
