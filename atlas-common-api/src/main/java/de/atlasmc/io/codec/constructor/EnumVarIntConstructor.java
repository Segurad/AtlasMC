...
public class EnumVarIntConstructor<T, K extends Enum<K> & IDHolder> extends AbstractRegistryConstructor<T, K> {

	private final Function<T, K> keyReverseSupplier;
	
	public EnumVarIntConstructor(RegistryKey<K> registry, Function<K, T> constructor, Function<T, K> keyReverseSupplier) {
