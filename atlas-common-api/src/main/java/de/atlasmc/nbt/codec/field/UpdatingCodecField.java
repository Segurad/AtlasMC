...
/**
 * Field that updates a existing object
 * @param <T>
 * @param <V>
 */
public class UpdatingCodecField<T, V> extends AbstractUpdatingField<T, V, NBTCodec<V>> {

	public UpdatingCodecField(UpdatingCodecFieldBuilder<T, V> builder) {
		super(builder);
	}
